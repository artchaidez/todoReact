...
export default function Register({ setUser }) {
    ...
    return (<form onSubmit={e => { e.preventDefault(); setUser(username) }}>
        ...
        <input type="submit" value="Register" disabled={username.length === 0 || password.length === 0 || password !== passwordRepeat} /></form>
    )
}
